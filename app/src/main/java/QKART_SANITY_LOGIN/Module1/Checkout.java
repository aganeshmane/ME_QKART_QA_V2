...
public class Checkout {
    ...
    public Boolean verifyInsufficientBalanceMessage() {
        ...
        try {
            ...
            WebElement errormsgElement = driver.findElement(By.xpath("//div[@id='notistack-snackbar']"));
            errormsgElement.isDisplayed();
            if(errormsgElement.getText().equals("You do not have enough balance in your wallet for this purchase")){
                status =true;
            }
            return status;
        } catch (Exception e) {
