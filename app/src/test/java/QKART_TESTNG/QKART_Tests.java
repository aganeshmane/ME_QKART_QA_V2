...
public class QKART_Tests {
        ...
        public void TestCase03() throws InterruptedException {
                ...
                Assert.assertTrue(status, "Search Product failed");
                // if (!status) {
                ...
                Assert.assertTrue(status, "No product found");
                ...
                Assert.assertFalse(status, "Unable to find message --> No product found");
        ...
        public void TestCase04() throws InterruptedException {
                ...
                for (WebElement webElement : searchResults) {
                        ...
                        if (result.verifySizeChartExists()) {
                                ...
                                Assert.assertTrue(status, "existance of dropdown  failed");
                                ...
                                if (result.openSizechart()) {
                                        ...
                                        Assert.assertTrue(status, "close size chart failed");
        ...
        @Parameters({"YONEX", "Tan"})
        public void TestCase05(String YONEX, String Tan) throws InterruptedException {
                Boolean status;
                ...
                Assert.assertTrue(status, "Base url not same failed");
        ...
        // Xtend--->Xtend Smart Watch
        // Yarine--->Yarine Floor Lamp
        ...
        public void TestCase06(String Xtend, String Yarine) throws InterruptedException {
                ...
                status = driver.getCurrentUrl().endsWith("/thanks");
                Assert.assertTrue(status, "Base URL not same");
        ...
        public void TestCase08() throws InterruptedException {
                ...
                Assert.assertTrue(status, "VeryFy cartContent Failed");
        ...
        public void TestCase09() throws InterruptedException {
                ...
                Assert.assertTrue(status, "Base Page url not same");


                // if (!status) {
                // logStatus("Step Failure", "Verifying parent page url didn't change on privacy
                // policy link
                ...
                sa.assertTrue(status, "Text is not Privacy Policy");
                // if (!status) {
                // logStatus("Step Failure", "Verifying new tab opened has Privacy Policy page
                // heading
                ...
                // if (!status) {
                // logStatus("Step Failure", "Verifying new tab opened has Terms Of Service page
                // heading
                // failed", status ? "PASS" : "FAIL");
                // takeScreenshot(driver, "Failure", "TestCase9");
                // logStatus("End TestCase",
        ...
        public void TestCase11() throws InterruptedException {
                ...
                Assert.assertTrue(status, "Verify that 3 Advertisements are not available");
